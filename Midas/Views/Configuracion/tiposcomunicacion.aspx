...
<asp:Content ID="pedidoContent" ContentPlaceHolderID="MainContent" runat="server">
			...
			<div class="page-header">
				<div class="page-title">
					<h3>Tipos de comunicación<small>Tipos de comunicación registrados en el sistema</small></h3>
				</div>
			</div>
			<!-- /page header -->
					                ...
					                <table class="table table-bordered">
					                    ...
					                    <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a onclick="return confirm('¿Está seguro que desea eliminar el registro?');" href="/evr/configuracion/eliminar_tipocomunicacion/<%= item.Cells[0].Text %>" title="Eliminar"><i class="icon-remove"></i></a>
                                                </td>
                                                <% } %>
                                            </tr>
                                            <% }%>
                        ...
                        <% if (user.perfil == 1 || user.perfil == 3)
                           { %>
                        <a href="/evr/configuracion/editar_tipocomunicacion/0" title="Nuevo tipo de comunicación"><button class="btn btn-primary" >Nuevo tipo de comunicación</button></a>
                        <% } %>
