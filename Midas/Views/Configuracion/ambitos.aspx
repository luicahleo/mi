...
<asp:Content ID="pedidoContent" ContentPlaceHolderID="MainContent" runat="server">
			...
			<div class="page-header">
				<div class="page-title">
					<h3>Ámbitos<small>Ámbitos registrados en el sistema</small></h3>
				</div>
			</div>
			<!-- /page header -->
					                ...
					                <table class="table table-bordered">
					                    ...
					                    <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a onclick="return confirm('¿Está seguro que desea eliminar el registro?');" href="/evr/Configuracion/eliminar_ambito/<%= item.Cells[0].Text %>" title="Eliminar"><i class="icon-remove"></i></a>
                                                </td>
                                                <% } %>
                                            </tr>
                                            <% }%>
                        ...
                        <% if (user.perfil == 1 || user.perfil == 3)
                           { %>
                        <a href="/evr/Configuracion/editar_ambito/0" title="Nuevo tipo"><button class="btn btn-primary" >Nuevo ámbito</button></a>
                        <% } %>
