					                ...
					                <table class="table table-bordered">
					                    ...
					                    <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a onclick="return confirm('¿Está seguro que desea eliminar el registro?');" href="/evr/configuracion/eliminar_tipoeventoambiental/<%= item.Cells[0].Text %>" title="Eliminar"><i class="icon-remove"></i></a>
                                                </td>
                                                <% } %>
                                            </tr>
                                            <% }%>
