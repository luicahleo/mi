...
<script runat="server">  
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Session["usuario"] != null)
        {
            ...
            DatosPedidos.DataSource = ViewData["sistema"];
    ...
    <form role="form" action="#" runat="server">
        ...
        <div class="panel panel-default"  style="margin-left:20px;" >
            ...
            <center>
					                    ...
					                    <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="/evr/Configuracion/editar_sistema/<%= item.Cells[0].Text %>" title="Editar"><i class="icon-pencil"></i></a>
                                                </td>
                                                <td class="text-center">
                                                    <a onclick="if(!confirm('¿Está seguro de que desea eliminar este sistema?')) return false;" href="/evr/Configuracion/eliminar_sistema/<%=item.Cells[0].Text %>" title="Eliminar"><i class="icon-remove"></i></a>
                                                </td>
                                                <% } %>
                                            </tr>
                                            <% }%>
					                            ...
					                            <tr>
                                                    ...
                                                    <td style="padding-right:15px">
                                                        <div style="text-align:right">  
                                                            <input id="GuardarSistema" type="submit" value="Añadir Sistema" class="btn btn-primary run-first"  name="submit">        
                        ...
                        <% if (user.perfil == 1 || user.perfil == 3)
                            { %>
                        <a href="/evr/Configuracion/editar_sistema/0" title="Añadir sistema"><button class="btn btn-primary" >Añadir sistema</button></a>
                        <% } %>
                        </div>--%>
					            </div>
                                </center>
        ...
        <div class="form-actions text-right">
            <input id="GuardarArea" type="submit" value="Guardar datos" class="btn btn-primary run-first" name="submit">
            ...
            <a href="/evr/configuracion/editar_central/<%=oCentro.id %>" title="Volver" class="btn btn-primary run-first">Volver</a>
        </div>
