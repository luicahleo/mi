...
<script runat="server">
    ...
    {
        DatosPedidos.DataSource = ViewData["aspectosParametros"];
...
<asp:Content ID="pedidoContent" ContentPlaceHolderID="MainContent" runat="server">
			...
			<div class="page-header">
				<div class="page-title">
					<h3>Parametros Ambientales<small>Parametros ambientales registrados en el sistema</small></h3>
				</div>
			</div>
			<!-- /page header -->
					                    ...
					                    <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="/evr/configuracion/editar_aspectoTipo/<%= item.Cells[0].Text %>" title="Editar"><i class="icon-pencil"></i></a>
                                                </td>
                                                <td class="text-center">
                                                    <a onclick="return confirm('¿Está seguro que desea eliminar el registro?');" href="/evr/configuracion/eliminar_aspectoTipo/<%= item.Cells[0].Text %>" title="Eliminar"><i class="icon-remove"></i></a>
                                                </td>
                                                <% } %>
                                            </tr>
                                            <% }%>
                        ...
                        <% if (user.perfil == 1 || user.perfil == 3)
                           { %>
                        <a href="/evr/configuracion/editar_aspectoTipo/0" title="Nuevo Parametro"><button class="btn btn-primary" >Nuevo Parámetro</button></a>
                        <% } %>
