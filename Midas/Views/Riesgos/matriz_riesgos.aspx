...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        TiposRiesgos.DataSource = ViewData["tipos_riesgos"];
...
<asp:Content ID="pedidoContent" ContentPlaceHolderID="MainContent" runat="server">
    <script type="text/javascript" src="<%=ResolveClientUrl("~/ext/js/Riesgos/matriz_riesgos.js") %>"></script>
    <%--<link href="<%=ResolveClientUrl("~/ext/css/Riesgos/matriz_riesgos.css") %>" rel="stylesheet" />--%>
    <link rel="stylesheet" href="<%=ResolveClientUrl("~/ext/css/Riesgos") %>/matriz_riesgos.css?v=1.123"/>
    <!-- Page header -->
    <div class="page-header">
        <div class="page-title">
            <h3>Matriz de riesgos<small>Tipos de riesgos registrados en el sistema.</small></h3>
        </div>
    </div>
    <!-- /page header -->
                    ...
                    <thead>
                        <tr style="background-color: #41b9e6;">
                            ...
                            <% 
                                ...
                                {
                            %>
                            <th class="text-center" style="background-color: #2f5496" title="<%= item.Cells[1].Text%>">
                                <div>
                                        <h2 style="color: white; font-size:12px;"><%= item.Cells[0].Text%></h2>
                                </div>
                                <%--                                <div>
                            ...
                            <th class="task-desc icon-remove" style="text-align: center; color: white;background-color:#2f5496; font-size: 12px;" font-weight: bold" title="Eliminar">
                            </th>
                        ...
                        <%
                            ...
                            {%>
                                <tr style="background-color: #ff0f64" class="Tecnologia" tecnologia="<%=tecno.Cells[0].Text %>" version='<%=ViewData["version"] %>'>
                                    <td columnaprincipal="" colspan="31" style="font-size: 15px; font-weight: bold; color: white;"><%=tecno.Cells[1].Text %>
                                    </td>
                                    <td colspan="1" style="font-size: 15px; font-weight: bold;" class="text-center">
                                        <a onclick="EliminarTecnologiaCentroVersion(this)">
                                ...
                                <% 
                                    ...
                                    //Instalaciones son Areas nivel1
                                ...
                                <tr style="background-color: #426ee5; font-weight: bold; color: white;" class="AREA" id="AREA_<%=item.Cells[0].Text%>" area="<%=item.Cells[0].Text%>" tecnologia="<%=tecno.Cells[0].Text %>" version='<%=ViewData["version"] %>'>
                                    ...
                                    <td class="task-desc" style="text-align: center;">
                                        <%  if (sistemas.Where(x => x.id_areanivel1 == int.Parse(item.Cells[0].Text)).Count() == 0)
                                            {%>
                                        <a class="EditarRegistro" id="<%="btn_edit_" + item.Cells[1].Text  %>">
                                    ...
                                    <td class="task-desc" style="text-align: center;" >
                                        <%if (imagenes_areas.Where(x => x.id_areanivel1 == int.Parse(item.Cells[0].Text)).Count() > 0)
                                            { %>
                                        <a class="Subir" id="<%="btn_sub_" + item.Cells[0].Text  %>" atributoSubirNivel1="nivel1">
                                            <i class="icon-camera" style="color: green;" identificador="<%=item.Cells[0].Text%>" ></i>
                                        </a>
                                        <% }
                                            else
                                            { %>
                                        <a class="Subir" id="<%="btn_sub_" + item.Cells[0].Text  %>" atributoSubirNivel1="nivel11">
                                ...
                                <tr style="background-color: #b4c6e7;" hidden class="SISTEMA" id="AREA_<%=item.Cells[0].Text%>_SISTEMA_<%=itemS.Cells[0].Text%>" area="<%=item.Cells[0].Text%>" sistema="<%=itemS.Cells[0].Text%>" tecnologia="<%=tecno.Cells[0].Text %>">
                                    ...
                                    <td class="task-desc" style="text-align: center;">
                                        ...
                                        <%--<a id="<%="btn_new_" + itemS.Cells[1].Text  %>" name="Nuevo_Sistema">
                                    ...
                                    <td class="task-desc" style="text-align: center;">
                                        <a class="Eliminar" id="<%="btn_del_" + itemS.Cells[1].Text  %>">
                                            <i class="icon-remove" style="color: red;"></i>
                                        </a>
                                    </td>
                                    <td class="task-desc" style="text-align: center;">
                                ...
                                <tr style="background-color: #f4b083; font-weight: bold;  font-size: 9px;" hidden class="EQUIPO" id="AREA_<%=item.Cells[0].Text%>_SISTEMA_<%=itemS.Cells[0].Text%>_EQUIPO_<%=itemE.Cells[0].Text%>" area="<%=item.Cells[0].Text%>" sistema="<%=itemS.Cells[0].Text%>" equipo="<%=itemE.Cells[0].Text%>" tecnologia="<%=tecno.Cells[0].Text %>">
                                    ...
                                    <td class="task-desc" style="text-align: center;">
                                        ...
                                        <% }
                                            ...
                                            {%>
                                        <a class="EditarRegistro" conhijos="si" id="<%="btn_edit_" + itemE.Cells[1].Text  %>">
                                            <i class="icon-pencil" style="color: gray;"></i>
                                        </a>
                                        <%} %>
                                    </td>
                                    <td class="task-desc" style="text-align: center;">
                                        <a class="Eliminar" id="<%="btn_del_" + itemE.Cells[1].Text  %>">
                                            <i class="icon-remove" style="color: red;"></i>
                                        </a>
                                    </td>
                                    <td class="task-desc" style="text-align: center;">
                                ...
                                <tr style="background-color: #fbe4d5; font-weight: bold;  font-size: 9px;" hidden class="NIVELCUATRO"
                                    ...
                                    <td class="task-desc" style="text-align: center;">
                                        <a class="Eliminar" id="<%="btn_del_" + item4.Cells[1].Text  %>">
                                            <i class="icon-remove" style="color: red;"></i>
                                        </a>
                                    </td>
                                    <td class="task-desc" style="text-align: center;">
    ...
    <div class="footer clearfix">
        ...
        <div style="text-align: right">
            ...
            <% } %>
            <a href="/evr/Riesgos/lista_matrices" title="Volver a Listado de Version Matriz" class="btn btn-primary run-first">Volver a Listado de Version Matriz</a>
        </div>
        <p>
            <br />
        </p>
    ...
    <script>
        ...
        $('.dropbtn').on('click', function () {
            ...
            if (typeof ($(boton)[0]) == "undefined") {
                ...
                if (typeof ($(boton)[0]) == "undefined") {
                    boton = padre.find('div[id="DropEquipo"]');
                }
            }
