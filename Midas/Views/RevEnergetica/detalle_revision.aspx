...
<asp:Content ID="contentEditarPedido" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="page-header">
        <div class="page-title">
            <h3>
                Detalle de la revisión<asp:Label runat="server" ID="lblNombreProc"></asp:Label></h3>
        </div>
    </div>
    <!-- /page header -->
                    ...
                    <tr style="padding-top:20px">
                        <td>
                            <% if (oRevision != null && oRevision.planificacionenergetica != null)
                               { %>
                               <center>
                            <a title="Ver Planificación" href="/evr/revenergetica/ObtenerPlanificacion/<%=oRevision.id %>");"><i style="font-size:50px" class="icon-download"></i></a><br /><br />
                        ...
                        <% if (oRevision != null && oRevision.revisionenergetica != null)
                           { %>
                           <center>
                            <a title="Ver Revisión" href="/evr/revenergetica/ObtenerRevision/<%=oRevision.id %>");"><i style="font-size:50px" class="icon-download"></i></a><br /><br />
