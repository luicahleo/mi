...
<script runat="server">
    ...
    {
        DatosPedidos.DataSource = ViewData["indgen"];
...
<asp:Content ID="pedidoContent" ContentPlaceHolderID="MainContent" runat="server">
			...
			<div class="page-header">
				<div class="page-title">
					<h3>Indicadores <small>Indicadores Genéricos</small></h3>
				</div>
			</div>
			<!-- /page header -->
					            ...
					            <div style="width:85%" class="datatablePedido">
					                <table class="table table-bordered">
					                    ...
					                    <tbody>
                                            ...
                                            <tr>
                                                <td class="task-desc">
                                                    <%= item.Cells[1].Text + item.Cells[2].Text + item.Cells[6].Text%>
                                                </td>
                                                <td class="task-desc">
                                                    <%= item.Cells[7].Text %>
                                                </td>
                                                <td class="task-desc">
                                                    <%= item.Cells[4].Text + " - " + item.Cells[5].Text%>
                                                </td>
                                                <td class="text-center">
                                                    <a href="/evr/Home/editar_indgen/<%= item.Cells[0].Text %>" title="Editar"><i class="icon-pencil"></i></a>
                                                </td>
                                                <td class="text-center">
                                                    <a href="/evr/Home/eliminar_indgen/<%= item.Cells[0].Text %>" title="Eliminar"><i class="icon-remove"></i></a>
                                                </td>
                                            </tr>
                                            <% }%>
                       ...
                       <%-- <input id="NuevaCentral" type="submit" value="Nueva Central" class="btn btn-primary run-first" />--%>
                        <%--</form>--%>
                        <a href="/evr/Home/editar_indgen/0" title="Nuevo Indicador"><button class="btn btn-primary" >Nuevo Indicador</button></a>
