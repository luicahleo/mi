...
================================================== */
	...
	oTable = $('.datatable table').dataTable({
		...
		"oLanguage": {
			...
			"sLengthMenu": "<span>Mostrando :</span> _MENU_",
			"oPaginate": { "sFirst": "Primera", "sLast": "Ultima", "sNext": ">", "sPrevious": "<" }
		},
	    "aaSorting": []
    });

    oTable = $('.datatableOrden table').dataTable({
		"bJQueryUI": false,
		"bAutoWidth": false,
		"sPaginationType": "full_numbers",
		"sDom": '<"datatable-header"fl><"datatable-scroll"t><"datatable-footer"ip>',
    ...
    oTable = $('.datatablePedido table').dataTable({
		"bJQueryUI": false,
		"bAutoWidth": false,
		"sPaginationType": "full_numbers",
		"sDom": '<"datatable-header"fl><"datatable-scroll"t><"datatable-footer"ip>',
...
//	      { "bSortable": false, "aTargets": [ 0,1,2,3 ] }
//	    ]
//CAMBIODATATABLEEQUIPO
    });

//	oTable = $('.datatableMatrizRiesgos table').dataTable({
//		"bJQueryUI": false,
//		"bAutoWidth": false,
//		"sPaginationType": "full_numbers",
//		"sDom": '<"datatable-header"fl><"datatable-scroll"t><"datatable-footer"ip>',
...
//	});
	...
	oTable = $('.datatable-tasks table').dataTable({
		...
		"sDom": '<"datatable-header"fl><"datatable-scroll"t><"datatable-footer"ip>',
		"oLanguage": {
			"sSearch": "<span>B&uacute;squeda:</span> _INPUT_",
			"sLengthMenu": "<span>Show tasks:</span> _MENU_",
			"sInfo": "Mostrando _START_ a _END_ de _TOTAL_ pedidos",
	...
	oTable = $('.datatable-tasksDocEmpresa table').dataTable({
		"bJQueryUI": false,
		"bAutoWidth": false,
		"bFilter": false,
		"bLengthChange": false,
	...
	oTable = $('.datatable-tasksEmpresa table').dataTable({
		"bJQueryUI": false,
		"bAutoWidth": false,
		"bFilter": false,
		"bLengthChange": false,
	...
	oTable = $('.datatable-tasksTrabajadores table').dataTable({
		"bJQueryUI": false,
		"bAutoWidth": false,
		"bFilter": false,
		"bLengthChange": false,
		...
		"oLanguage": {
			"sSearch": "<span>B&uacute;squeda:</span> _INPUT_",
			"sLengthMenu": "<span>Show tasks:</span> _MENU_",
			"sInfo": "Mostrando _START_ a _END_ de _TOTAL_ trabajadores",
			"oPaginate": { "sFirst": "Primero", "sLast": "&Uacute;ltimo", "sNext": ">", "sPrevious": "<" }
		},
		"aaSorting": [],
		"aoColumnDefs": [
	...
	oTable = $('.datatable-tasksSubsanaciones table').dataTable({
		"bJQueryUI": false,
		"bAutoWidth": false,
		"bFilter": false,
		"bLengthChange": false,
		...
		"oLanguage": {
			"sSearch": "<span>B&uacute;squeda:</span> _INPUT_",
			"sLengthMenu": "<span>Show tasks:</span> _MENU_",
			"sInfo": "Mostrando _START_ a _END_ de _TOTAL_ subsanaciones",
			"oPaginate": { "sFirst": "Primero", "sLast": "&Uacute;ltimo", "sNext": ">", "sPrevious": "<" }
		},
		"aaSorting": [],
		"aoColumnDefs": [
	...
	$('.dataTables_filter input[type=text]').attr('placeholder','Escribe para buscar..');
...
================================================== */
	...
	$('.bar-success').sparkline(
		'html', {type: 'bar', barColor: '#44c4c0', height: '35px', barWidth: "5px", barSpacing: "2px", zeroAxis: "false"}
	);
